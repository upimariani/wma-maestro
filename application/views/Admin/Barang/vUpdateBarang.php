			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card card-info">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<?php echo form_open_multipart('Admin/cBarang/update/' . $barang->id_jenis); ?>
						<div class="card-body">
							<div class="row">
								<div class="col-lg-12">
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="number" name="harga" value="<?= $barang->harga_gudang ?>" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Harga Barang">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="text" name="stok" class="form-control" id="exampleInputEmail1" value="<?= $barang->stok_gudang ?>" placeholder="Masukkan Stok Barang">
